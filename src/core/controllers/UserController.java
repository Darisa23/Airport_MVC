...
public class UserController {
    ...
    public Response setUserRole(UserRole role, int totalTabs) {
        ...
        if (role == UserRole.ADMINISTRATOR) {
            ...
            tabStates.set(5, false); // Update Info
            tabStates.set(6, false); // Add to Flight
            tabStates.set(7, false); // Show my Flights 
            ...
            tabStates.set(6, true); // Add to Flight
            tabStates.set(7, true); // Show my Flights
        }
